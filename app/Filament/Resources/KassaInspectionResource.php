...
use App\Filament\Resources\KassaInspectionResource\Pages;
use App\Filament\Resources\KassaInspectionResource\RelationManagers;
use App\Models\KassaInspection;
...
class KassaInspectionResource extends Resource
{
    ...
    {
        return [
            'index' => Pages\ListKassaInspections::route('/'),
            'create' => Pages\CreateKassaInspection::route('/create'),
            'edit' => Pages\EditKassaInspection::route('/{record}/edit'),
        ];
    }
}
