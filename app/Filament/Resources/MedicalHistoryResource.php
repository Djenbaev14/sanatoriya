...
use function App\Helpers\calculateMealCost;
...
class MedicalHistoryResource extends Resource
{
    ...
    protected static function calculateMealCost($medicalHistoryId)
    {
        ...
        return $medicalMeal->mealType->daily_price * $daysStayed;
    }
        ...
        return $table
            ->columns([
                ...
                TextColumn::make('patient.full_name')
                    ->label('ФИО')
                    ->sortable(),
                TextColumn::make('calculateMealCost')
                    ->label('Narx')
                    ->formatStateUsing(fn ($state, $record) => calculateMealCost($record->id)),
