        ...
        <table style="width: 100%; border-collapse: collapse; table-layout: fixed;">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid #929292;">
                    ...
                    <td style="border: 1px solid #d1d5db; padding: 12px;">{{ number_format($accommodation->getBedAndMealCost()) }} сум</td>
                    ...
                    <td style="border: 1px solid #d1d5db; padding: 12px;"><a href="/admin/accommodations/{{$accommodation->id}}" style="color: #094ecd">Просмотр</a></td>
                </tr>
                @endforeach
            </tbody>
        </table>
